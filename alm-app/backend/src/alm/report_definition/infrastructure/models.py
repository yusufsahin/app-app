...
class ReportDefinitionModel(Base):
    ...
    catalog_key: Mapped[str] = mapped_column(String(128), nullable=True)
    ...
    builtin_report_id: Mapped[str] = mapped_column(String(256), nullable=True)
    ...
    last_validation_message: Mapped[str] = mapped_column(Text, nullable=True)
