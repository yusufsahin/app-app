...
class AddProjectMemberHandler(CommandHandler[ProjectMember]):
    def __init__(
        self,
    ...
    async def handle(self, command: Command) -> ProjectMember:
        ...
        existing = await self._project_member_repo.find_by_project_and_user(
        ...
        return await self._project_member_repo.add(member)
