...
|---------|------|---------------------|
| [@visera Docs Index](https://github.com/yusufsahin/visera/blob/main/docs/INDEX.md) | `@visera` ürün, mimari, güvenlik, AI ve entegrasyon doküman giriş noktası | Visera kapsamı, roadmap, backlog ve entegrasyon tasarımına başlarken |
