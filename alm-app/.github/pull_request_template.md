...
`backend/alm_meta/artifact_catalog.yaml` içindeki `artifact_id` değerlerini listeleyin:

- 
- 

> CI gate için `backend/alm_meta/change_manifest.yaml` bu PR ile **senkron** güncellenmeli (`change_type`, `affected_artifacts`, `change_set_id`).
