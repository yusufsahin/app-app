...
declare module "@mui/material/styles" {
  ...
  // eslint-disable-next-line @typescript-eslint/no-empty-object-type -- MUI augmentation
  ...
  return {
    palette: {
      ...
      primary: {
        ...
        ...(mode === "dark" && { light: brand[300], main: brand[400], dark: brand[700] }),
      },
      info: {
        light: brand[100],
        main: brand[300],
      ...
      warning: {
        ...
        main: orange[400],
        dark: orange[800],
        ...(mode === "dark" && { light: orange[400], main: orange[500], dark: orange[700] }),
      },
      error: {
        light: red[300],
        main: red[400],
        dark: red[800],
        ...(mode === "dark" && { light: red[400], main: red[500], dark: red[700] }),
      },
      success: {
        light: green[300],
        main: green[400],
        dark: green[800],
        ...(mode === "dark" && { light: green[400], main: green[500], dark: green[700] }),
      },
      grey: { ...gray },
